...
HW061_API UClass* Z_Construct_UClass_AMovingActor();
HW061_API UClass* Z_Construct_UClass_AMovingActor_NoRegister();
...
struct Z_Construct_UClass_AMovingActor_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MoveSpeed_MetaData[] = {
		...
		{ "Comment", "//MoveSpeed, MaxRange, StartLocation\n" },
#endif
		{ "ModuleRelativePath", "MovingActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "MoveSpeed, MaxRange, StartLocation" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxRange_MetaData[] = {
		{ "Category", "MovingActor" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//\xef\xbf\xbd\xd3\xb5\xef\xbf\xbd\n" },
#endif
		{ "ModuleRelativePath", "MovingActor.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xef\xbf\xbd\xd3\xb5\xef\xbf\xbd" },
#endif
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingActor_Statics::NewProp_MoveSpeed = { "MoveSpeed", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingActor, MoveSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MoveSpeed_MetaData), NewProp_MoveSpeed_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingActor_Statics::NewProp_MaxRange = { "MaxRange", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingActor, MaxRange), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxRange_MetaData), NewProp_MaxRange_MetaData) };
...
template<> HW061_API UClass* StaticClass<AMovingActor>()
{
	return AMovingActor::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_a_Desktop_git_HW061_Source_HW061_MovingActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMovingActor, AMovingActor::StaticClass, TEXT("AMovingActor"), &Z_Registration_Info_UClass_AMovingActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingActor), 1695698539U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_a_Desktop_git_HW061_Source_HW061_MovingActor_h_2587921702(TEXT("/Script/HW061"),
	Z_CompiledInDeferFile_FID_Users_a_Desktop_git_HW061_Source_HW061_MovingActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_a_Desktop_git_HW061_Source_HW061_MovingActor_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
